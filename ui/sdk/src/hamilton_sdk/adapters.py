...
class AsyncHamiltonTracker(
    ...
    async def ainit(self):
        ...
        logger.warning("Validating authentication against Hamilton BE API...")
        await self.client.validate_auth()
        logger.warning(f"Ensuring project {self.project_id} exists...")
        try:
            ...
            raise
        logger.warning("Initializing Hamilton tracker.")
        await self.client.ainit()
        logger.warning("Initialized Hamilton tracker.")
